...
| .NET/C# Best Practices | [dotnet-best-practices.prompt.md](dotnet-best-practices.prompt.md) |  |
| .NET/C# Design Pattern Review | [dotnet-design-pattern-review.prompt.md](dotnet-design-pattern-review.prompt.md) |  |
