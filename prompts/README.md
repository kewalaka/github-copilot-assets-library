...
|------|--------------|-------|
| AI Prompt Engineering Safety Review & Improvement | [ai-prompt-engineering-safety-review.prompt.md](ai-prompt-engineering-safety-review.prompt.md) | Comprehensive AI prompt engineering safety review and improvement prompt. Analyzes prompts for safety, bias, security vulnerabilities, and effectiveness while providing detailed improvement recommendations with extensive frameworks, testing methodologies, and educational content. |
| ASP.NET Minimal API with OpenAPI | [aspnet-minimal-api-openapi.prompt.md](aspnet-minimal-api-openapi.prompt.md) | Create ASP.NET Minimal API endpoints with proper OpenAPI documentation |
| Azure Cost Optimize | [az-cost-optimize.prompt.md](az-cost-optimize.prompt.md) | Analyze Azure resources used in the app (IaC files and/or resources in a target rg) and optimize costs - creating GitHub issues for identified optimizations. |
| Azure Resource Health & Issue Diagnosis | [azure-resource-health-diagnose.prompt.md](azure-resource-health-diagnose.prompt.md) | Analyze Azure resource health, diagnose issues from logs and telemetry, and create a remediation plan for identified problems. |
| Comment Code Generate A Tutorial | [comment-code-generate-a-tutorial.prompt.md](comment-code-generate-a-tutorial.prompt.md) | Transform this Python script into a polished, beginner-friendly project by refactoring the code, adding clear instructional comments, and generating a complete markdown tutorial. |
...
| Create GitHub Actions Workflow Specification | [create-github-action-workflow-specification.prompt.md](create-github-action-workflow-specification.prompt.md) | Create a formal specification for an existing GitHub Actions CI/CD workflow, optimized for AI consumption and workflow maintenance. |
...
| Create Readme | [create-readme.prompt.md](create-readme.prompt.md) | Create a README.md file for the project |
...
| NUnit Best Practices | [csharp-nunit.prompt.md](csharp-nunit.prompt.md) | Get best practices for NUnit unit testing, including data-driven tests |
| TUnit Best Practices | [csharp-tunit.prompt.md](csharp-tunit.prompt.md) | Get best practices for TUnit unit testing, including data-driven tests |
| XUnit Best Practices | [csharp-xunit.prompt.md](csharp-xunit.prompt.md) | Get best practices for XUnit unit testing, including data-driven tests |
...
| Entity Framework Core Best Practices | [ef-core.prompt.md](ef-core.prompt.md) | Get best practices for Entity Framework Core |
| Product Manager Assistant: Feature Identification and Specification | [gen-specs-as-issues.prompt.md](gen-specs-as-issues.prompt.md) | This workflow guides you through a systematic approach to identify missing features, prioritize them, and create detailed specifications for implementation. |
| Java Documentation (Javadoc) Best Practices | [java-docs.prompt.md](java-docs.prompt.md) | Ensure that Java types are documented with Javadoc comments and follow best practices for documentation. |
| JUnit 5+ Best Practices | [java-junit.prompt.md](java-junit.prompt.md) | Get best practices for JUnit 5 unit testing, including data-driven tests |
| Spring Boot Best Practices | [java-springboot.prompt.md](java-springboot.prompt.md) | Get best practices for developing applications with Spring Boot. |
| Javascript Typescript Jest | [javascript-typescript-jest.prompt.md](javascript-typescript-jest.prompt.md) | Best practices for writing JavaScript/TypeScript tests using Jest, including mocking strategies, test structure, and common patterns. |
| Spring Boot with Kotlin Best Practices | [kotlin-springboot.prompt.md](kotlin-springboot.prompt.md) | Get best practices for developing applications with Spring Boot and Kotlin. |
| Multi Stage Dockerfile | [multi-stage-dockerfile.prompt.md](multi-stage-dockerfile.prompt.md) | Create optimized multi-stage Dockerfiles for any language or framework |
| My Issues | [my-issues.prompt.md](my-issues.prompt.md) | List my issues in the current repository |
| My Pull Requests | [my-pull-requests.prompt.md](my-pull-requests.prompt.md) | List my pull requests in the current repository |
| Next Intl Add Language | [next-intl-add-language.prompt.md](next-intl-add-language.prompt.md) | Add new language to a Next.js + next-intl application |
| Review Azure Architecture Center Multitenant Service-Specific Guidance document | [review-aac-multitenant-service-specific-guidance.prompt.md](review-aac-multitenant-service-specific-guidance.prompt.md) | Review Azure Architecture Center multitenant service-specific guidance to ensure it is up-to-date with multitenant features provided by the service and guidance is still relevant. |
| Review And Refactor | [review-and-refactor.prompt.md](review-and-refactor.prompt.md) | Review and refactor code in your project according to defined instructions |
...
| Update Implementation Plan | [update-implementation-plan.prompt.md](update-implementation-plan.prompt.md) | Update an existing implementation plan file with new or update requirements to provide new features, refactoring existing code or upgrading packages, design, architecture or infrastructure. |
